...
Plane Surface(20) = {19};
Transfinite Line {1, 12, 6} = 6 Using Progression 1;
Transfinite Line {2, 10, 5} = 6 Using Progression 1;
Transfinite Line {8, 8, 9, 3} = 6 Using Progression 1;
Transfinite Line {7, 11, 4} = 6 Using Progression 1;
